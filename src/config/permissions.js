...
export const PERMISSIONS = {
  ...
  AASIS_VIEW: 'aasis.view',
  AASIS_CREATE: 'aasis.create',
  AASIS_UPDATE: 'aasis.update',
  AASIS_DELETE: 'aasis.delete',
...
const PROFESSIONAL_PERMISSIONS = [
  ...
  PERMISSIONS.AASIS_VIEW,
  PERMISSIONS.AASIS_CREATE,
  PERMISSIONS.AASIS_UPDATE,
